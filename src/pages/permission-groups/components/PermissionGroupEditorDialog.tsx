...
export default function PermissionGroupEditorDialog({ id, onSuccess, onCancel }: Props) {
    ...
    const getDetail = async () => {
        ...
        setLoading(true);
        var r = await PermissionGroupService.detail(id);
        if (r.success) {
            setForm(r.data);
            setLoading(false);
        }
    ...
    const save = async () => {
        ...
        if (id) {
            r = await PermissionGroupService.update(form);
        } else {
            r = await PermissionGroupService.create(form);
        }
        if (r.success) {
