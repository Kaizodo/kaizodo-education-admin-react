...
export default function OrderValueCard({ order }) {
    if (!order) return null;

    const totalValue = order.total_value || 0;
    const deliveredValue = order.delivered_value || 0;
    const cancelledValue = order.cancelled_value || 0;
            ...
            <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-emerald-50 rounded-xl p-4">
                        ...
                        <p className="text-2xl font-bold text-emerald-700">${deliveredValue.toFixed(2)}</p>
                    ...
                    <div className="bg-amber-50 rounded-xl p-4">
                        ...
                        <p className="text-2xl font-bold text-amber-700">${pendingValue.toFixed(2)}</p>
                    </div>
                    ...
                    <div className="bg-red-50 rounded-xl p-4">
                        ...
                        <p className="text-2xl font-bold text-red-700">${cancelledValue.toFixed(2)}</p>
