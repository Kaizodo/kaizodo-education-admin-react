...
function MultiProductPicker({ products, onSelect, filterOptions }: { products: Product[], onSelect: (products: Product[]) => void, filterOptions: any }) {
...
export function pickMultiProduct({ title = 'Pick Products', products, subtitle, ...rest }: {
    title?: string,
    subtitle?: string,
