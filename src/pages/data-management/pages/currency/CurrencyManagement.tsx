...
const LazyEditorDalog = lazy(() => import('./components/CurrencyEditorDailog'));
...
export default function CurrencyManagement() {
    ...
    const search = async () => {
        setSearching(true);
        var r = await CurrencyService.search(filters);
        if (r.success) {
            setPaginated(r.data);
        }
        setSearching(false);
    ...
    const openEditor = async (id?: number) => {
        const modal_id = Modal.show({
            title: id ? 'Update Currency' : 'Add Currency',
    ...
    return (
        <AppPage title='Currency' subtitle='Manage currency from this section' actions={<Btn onClick={() => openEditor()}><FaPlus />Add New</Btn>}>
            <AppCard>
